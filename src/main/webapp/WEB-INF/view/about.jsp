            ...
            <div class="am-tabs-bd">
                <div class="am-tab-panel am-fade am-in am-active" id="tab1">
                    ...
                    <blockquote>
                        ...
                        <p>前端框架采用的是<a href="http://amazeui.shopxo.net/" target="_blank">Amaze UI</a>,弹窗控件和分页控件采用的是<a href="https://www.layui.com/" target="_blank">Layer</a>和<a href="http://laypage.layui.com/" target="_blank">Laypage</a></p>
                    </blockquote>
                </div>
            </div>
        </div>
